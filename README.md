...
2.  **虚电路 (Virtual Circuit)**：发信前，先发一个特殊的信号告诉沿途邮局：“我要发一堆信，请给我在你们的记录本上占个坑，编号是 001”。之后发出的信**不写地址**，只写 **“编号 001”**。邮局看到 001，就直接往预定好的路线上扔。**代表**：ATM、**MPLS**（它的全名就叫“标签交换”）。
...
>
> **提示**：这道题要看之前总结的，分组交换的两种逻辑（数据报和虚电路）。
>
> **答案选项**：**C**
