...
**提示**：本仓库含有的PPT比较占空间，总共有100+MB，点击GitHub的Code--Download ZIP手动下载可以不下载git记录，从而省掉一些空间。此外，有一些早年真题是英文的，但是现在都是中文试卷，我已经把题目进行了翻译。
...
>     *   **非阻塞模式**：recv()会立即返回。若没有recv()到任何东西，则返回一个错误码。
>
> 2.  **字节对齐**：
>     *   **n 的含义**：设定变量按 **n 字节对齐**。
